module.exports = app => {
	...
	register(require('./model-builder/components/relation/relation-options.directive.js'));
	register(require('./model-builder/components/relation/relation.directive.js'));
